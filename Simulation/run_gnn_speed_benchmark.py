...
parser.add_argument('-a','--gpuarch',default='RTX2080TI',type=str,help='GPU architecture')
# GNN
...
for mid in [128,96,64,48,32]:
    for multisim in [64,128,256]:
        
        args.modelid = mid
        args.num_rep = multisim
        ...
        for arg in vars(args):
            if arg in ['folder','mapping_file','ptfile','npfile','pdb_id','ns','file','num_rep','gpuarch']:
                continue
        ...
        run_name += '_benchmark_' + args.gpuarch + '_pub'
